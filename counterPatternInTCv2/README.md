Input data contains rotating counters in each trigger cells ADC	value.  Each counter is 7 bits (to fit in the 7 bits of dat for each TC), rolling over at 128
